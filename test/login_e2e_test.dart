...
void main() {
  group('Login E2E Tests', () {
    ...
    testWidgets('should successfully login with valid credentials', (WidgetTester tester) async {
      await tester.pumpWidget(createTestApp());
      await tester.pumpAndSettle();
    ...
    testWidgets('should have password visibility toggle button', (WidgetTester tester) async {
      await tester.pumpWidget(createTestApp());
      await tester.pumpAndSettle();
    ...
    testWidgets('should use demo credentials when demo button is pressed', (WidgetTester tester) async {
      await tester.pumpWidget(createTestApp());
      await tester.pumpAndSettle();
    ...
    testWidgets('should switch between login and register tabs', (WidgetTester tester) async {
      await tester.pumpWidget(createTestApp());
      await tester.pumpAndSettle();
    ...
    testWidgets('should login with premium demo user', (WidgetTester tester) async {
      await tester.pumpWidget(createTestApp());
      await tester.pumpAndSettle();

      // Use premium demo credentials
      await tester.enterText(find.byType(TextFormField).first, 'premium@test.com');
      await tester.enterText(find.byType(TextFormField).last, 'password123');
