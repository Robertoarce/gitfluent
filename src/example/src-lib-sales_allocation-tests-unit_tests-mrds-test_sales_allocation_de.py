...
import pandas as pd
from turing_sales_allocation.mrds.sales_allocation_de import SalesAllocationDE
...
class TestSalesAllocationDE(TestCase):
    """Test Case Class for testing Sales Allocation DE Class"""

    @patch("turing_sales_allocation.mrds.sales_allocation_de.SalesAllocationDE."
           "get_data_from_sql")
    @patch("turing_sales_allocation.mrds.sales_allocation_de.get_first_row_on_group")
    @patch("turing_sales_allocation.mrds.sales_allocation_de.impute_column")
    @patch("turing_sales_allocation.mrds.sales_allocation_de.pivot_column_group")
    @patch("turing_sales_allocation.mrds.sales_allocation_de.replace_space_col_name")
    @patch("turing_sales_allocation.mrds.sales_allocation_de.select_and_dropna_on_cols")
    @patch("turing_sales_allocation.mrds.sales_allocation_de.null_outlier_treatment")
    def test_get_sales_allocation_mrds(
        ...
        """
        Tests the function get_sales_allocation_mrds that generates mrds for Germany.
        """
        ...
        sales_allocation_mrds = SalesAllocationDE(
