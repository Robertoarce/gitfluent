    ...
    if (userService.isLoggedIn) {
      ...
      if (userService.currentUser != null) {
        try {
          ...
          debugPrint(
              '🌍 AppHome._initializeServices: User preferences: Target: ${userService.currentUser!.targetLanguage}, Native: ${userService.currentUser!.nativeLanguage}, Support1: ${userService.currentUser!.supportLanguage1}, Support2: ${userService.currentUser!.supportLanguage2}');
