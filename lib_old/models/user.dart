...
class User {
  ...
  Map<String, dynamic> toSupabase() {
    ...
    // Remove language fields as they are now separate columns
    json.remove('target_language');
    json.remove('native_language');
    json.remove('support_language_1');
    json.remove('support_language_2');
  ...
  factory User.fromSupabase(Map<String, dynamic> data) {
    ...
    print('[User.fromSupabase] Raw data: $processedData');
    print(
    ...
    // Extract language preferences directly from the top-level data map
    processedData['target_language'] = processedData['target_language'] ?? 'it';
    processedData['native_language'] = processedData['native_language'] ?? 'en';
    // support_language_1 and 2 can be null in the database, so no default here
    processedData['support_language_1'] = processedData['support_language_1'];
    processedData['support_language_2'] = processedData['support_language_2'];
    ...
    print('[User.fromSupabase] Final data for fromJson: $processedData');
...
class UserPreferences {
  ...
  factory UserPreferences.fromJson(String jsonString) {
    try {
      debugPrint('🌍 UserPreferences.fromJson: Raw JSON string: $jsonString');
