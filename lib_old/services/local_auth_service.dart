...
class LocalAuthService implements AuthService {
  ...
  Future<AuthResult> createUserWithEmailAndPassword(
    ...
    try {
      ...
      _authStateController.add(_currentUser);
      debugPrint(
          'LocalAuth: User created and signed in: ${_currentUser!.email}');
      return AuthResult.success(_currentUser!);
    } catch (e) {
  ...
  Future<AuthResult> signInWithGoogle() async {
    ...
    return AuthResult.error(
        'Google Sign-In not available in local testing mode.');
  }
  ...
  Future<AuthResult> signInWithApple() async {
    await Future.delayed(const Duration(milliseconds: 1000));
    return AuthResult.error(
        'Apple Sign-In not available in local testing mode.');
  }
  ...
  Future<void> updatePremiumStatus(bool isPremium) async {
    ...
    _authStateController.add(_currentUser);
    debugPrint(
        'LocalAuth: Premium status updated to $isPremium for ${_currentUser!.email}');
  }
  ...
  Future<void> createTestPremiumUser() async {
    const emailLower = 'premium@test.com';
  ...
  Future<void> createTestRegularUser() async {
    const emailLower = 'regular@test.com';
